...
const lineHighlightColor = "#FFFF00";
...
function updateLineDisplay(lineName, visible) {
  ...
  switch (lineName) {
    case "west_continuous":
      ...
      map_2.setLayoutProperty("west_countryline", "visibility", visibility);
      break;
    case "middle_continuous":
      ...
      map_2.setLayoutProperty("middle_countryline", "visibility", visibility);
      break;
    case "east_continuous":
      ...
      map_2.setLayoutProperty("east_countryline", "visibility", visibility);
      break;
  }
}
