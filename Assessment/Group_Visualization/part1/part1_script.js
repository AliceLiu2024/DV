...
map_1.on("load", () => {
  ...
  map_1.addLayer({
    ...
    paint: {
      "circle-radius": 20,
      "circle-color": "rgba(64, 156, 255, 0.15)",
      "circle-blur": 1,
    },
  });
  ...
  map_1.addLayer({
    ...
    paint: {
      "circle-radius": 12,
      "circle-color": "rgba(64, 156, 255, 0.25)",
      "circle-blur": 0.5,
    },
  });
  ...
  map_1.addLayer({
    ...
    paint: {
      "circle-radius": 5,
      "circle-color": "rgba(64, 156, 255, 0.8)",
  ...
  style.textContent = `
    ...
    .pulse-circle {
        width: 12px;
        height: 12px;
        background-color: rgba(64, 156, 255, 0.6);
        border-radius: 50%;
        position: absolute;
...
`;
  ...
  map_1.on("mouseenter", "point", function (e) {
    ...
    map_1.setPaintProperty("point", "circle-color", "rgba(130, 200, 255, 0.9)");
  ...
  map_1.on("mouseleave", "point", function () {
    ...
    map_1.setPaintProperty("point", "circle-color", "rgba(64, 156, 255, 0.8)");
